    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          <h2 className="text-xs text-orange-500 tracking-widest font-medium title-font mb-1">CATEGORIES</h2>
            ...
            cards?.map((card) => {
              return (
                <Link to={`/categories/${card}`} className="p-4 md:w-1/3 cursor-pointer">
                  <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col hover:bg-orange-100 hover: shadow-xl">
                    ...
                    <div className="flex-grow">
                      <p className="leading-relaxed text-base">Embrace the allure of modern luxury as you explore our curated selection of electronics, fashion, and jewelry.</p>
