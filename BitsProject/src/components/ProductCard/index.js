        ...
        <div className="flex flex-wrap -m-4">
          {
            products.map((product) => {
              ...
              return (
                <Link to={`/products/${id}`} className="lg:w-[23%] md:w-1/2 p-4 w-full mb-4 cursor-pointer rounded-lg shadow ml-4 hover:bg-orange-100 hover: shadow-xl">
                  ...
                  <div className="mt-4">
                    ...
                    <h2 className="text-gray-700 title-font text-sm font-medium ">{title}</h2>
