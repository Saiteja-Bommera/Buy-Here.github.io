...
const Cart = () => {
  ...
  if(carts.length === 0) {
    return <div className=' h-[55vh] flex justify-center items-center text-4xl text-white bg-orange-400 '>Your bag is empty</div>
  }
    ...
    <div className="container mx-auto mt-10">
      <div className="flex shadow-md my-10">
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <button className="bg-orange-500 hover:bg-orange-600 px-5 py-2 text-sm text-white uppercase">Apply</button>
          <div className="border-t mt-8">
            <div className="flex font-semibold justify-between py-6 text-sm uppercase">
              <span>Total cost</span>
              <span>${(total + 10).toFixed(2)}</span>
            </div>
            <button className="bg-green-500 font-semibold hover:bg-green-600 py-3 text-sm text-white uppercase w-full">Proceed to Pay</button>
          </div>
        </div>
